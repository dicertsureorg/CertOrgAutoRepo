...
{
    public class ESN4CPage : BaseCertificatePage  
    {
        ...
        public ESN4CPage EnableViewMode(ViewMode viewMode)
        {
        ...
        public ESN4CPage ClickNext()
        {
            NextButton.Click();
            return this;
        }

        public ESN4CPage VerifyPage1Loads()
        {
            ...
            Assert.IsTrue(viewSource.Contains("PART 4 : RELATED REFERENCE DOCUMENTS (If any)"), "Part 4 title not present");
            return this;
        }

        public ESN4CPage VerifyPage2Loads()
        {
            //Url contains part=2
        ...
        public ESN4CPage VerifyPage3Loads()
        {
            //Url contains part=2
            ...
            Assert.IsTrue(viewSource.Contains("PART 6 :  DETAILS OF DEVIATIONS FROM THE RECOMMENDATIONS OF "), "Part 6 continuation title not correct");
            Assert.IsTrue(viewSource.Contains("PART 7 : COMMENTS ON EXISTING INSTALLATION"), "Part 7 continuation title not correct");
            return this;
        }

        public ESN4CPage VerifyPageContinuationPageLoads()
        {
            string viewSource = driver.PageSource;
        ...
        public ESN4CPage VerifyPart3Loads()
        {
            Assert.IsTrue(driver.Url.Contains("&part=3"));
            string viewSource = driver.PageSource;
        ...
        public ESN4CPage VerifyPart4Loads()
        {
        ...
        public ESN4CPage VerifyPart5Loads()
        {
            Assert.IsTrue(driver.Url.Contains("&part=5"));
            string viewSource = driver.PageSource;
            Assert.IsTrue(viewSource.Contains("DETAILS OF THE EMERGENCY LIGHTING INSTALLATION COVERED BY THIS CERTIFICATE"), "Part 5 title is not present");
            return this;
        }
        public ESN4CPage VerifyPart6Loads()
        {
            Assert.IsTrue(driver.Url.Contains("&part=6"));
            string viewSource = driver.PageSource;
            Assert.IsTrue(viewSource.Contains("DETAILS OF THE EMERGENCY LIGHTING INSTALLATION COVERED BY THIS CERTIFICATE"), "Part 6 title is not present");
            return this;
        }
        public ESN4CPage VerifyPart7Loads()
        {
        ...
        public ESN4CPage VerifyPart8Loads()
        {
        ...
        public ESN4CPage VerifyPart9Loads()
        {
        ...
        public ESN4CPage VerifyPart10Loads()
        {
        ...
        public ESN4CPage VerifyPart11Loads()
        {
