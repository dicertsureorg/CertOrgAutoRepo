...
{
    public class FAM7CPage : BaseCertificatePage  
    {
        ...
        public FAM7CPage EnableViewMode(ViewMode viewMode)
        {
        ...
        public FAM7CPage ClickNext()
        {
            NextButton.Click();
            return this;
        }
        public FAM7CPage SpecialClick()
        {
        ...
        public FAM7CPage VerifyPage1Loads()
        {
            string viewSource = driver.PageSource;
            Assert.IsTrue(viewSource.Contains("PART 1 : DETAILS OF THE COMPILER, CLIENT AND INSTALLATION"), "Part 1 title not present");
            ...
            Assert.IsTrue(viewSource.Contains("PART 3: ACCEPTANCE PROCEDURES"), "Part 3 title not present");
        ...
        public FAM7CPage VerifyPageContinuationPageLoads()
        {
            string viewSource = driver.PageSource;
        ...
        public FAM7CPage VerifyPart1Loads()
        {
            string viewSource = driver.PageSource;
            Assert.IsTrue(viewSource.Contains("DETAILS OF THE COMPILER"), "Part 1 title is not present");
            return this;
        }
        public FAM7CPage VerifyPart2Loads()
        {
        ...
        public FAM7CPage VerifyPart3Loads()
        {
            Assert.IsTrue(driver.Url.Contains("&part=3"));
            string viewSource = driver.PageSource;
            Assert.IsTrue(viewSource.Contains("  ACCEPTANCE PROCEDURES "), "Part 3 title is not present");
            return this;
        }
        public FAM7CPage VerifyPart4Loads()
        {
        ...
        public FAM7CPage VerifyPart5Loads()
        {
        ...
        public FAM7CPage VerifyPart6Loads()
        {
        ...
        public FAM7CPage VerifyPart7Loads()
        {
        ...
        public FAM7CPage VerifyPart8Loads()
        {
